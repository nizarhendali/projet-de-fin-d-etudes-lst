...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:hendali.nizar75@gmail.com?subject=Sample&body=${body}`)
    }
    return (
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3> Address</h3>
                        <p>Rue Al Farouk Al Rahali 2eme étage Etage Sidi Maarouf 4, Casablanca</p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">0701141201</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">Shop12@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
